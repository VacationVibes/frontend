...
public class AuthRepository {
    ...
    public void changePassword(String oldPassword, String newPassword, final AuthCallback<String> authCallback) {
        ...
        authApiService.changePassword(request).enqueue(new Callback<Void>() {
            ...
            public void onResponse(@NonNull Call<Void> call, @NonNull Response<Void> response) {
                if (response.isSuccessful()) {
                    authCallback.onSuccess("Password changed successfully!");
                } else {
                    handleVoidErrorResponse(response, authCallback);
                }
            }
